  ...
  <div class="form-control w-full">
    ...
    <div class="flex gap-2 mb-2">
      ...
      <button
        ...
        on:click={() =>
          (formData.bank_accounts_attributes[0].pix = formatCpfForPix(formData.cpf))}
      ...
      <button
        ...
        on:click={() =>
          (formData.bank_accounts_attributes[0].pix = formatPhoneForPix(formData.phones_attributes[0].phone_number))}
