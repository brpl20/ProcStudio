...
[Protótipo/Figma](https://www.figma.com/design/lOipWPVq1G3lzBCU4KdThU/ProcStudio?node-id=7388-10727&t=zeqryIP14BPDsBsc-0)

## Testing
[Testing Repo](https://github.com/brpl20/procstudio_tests)

## BLOG
[Blog Repo](https://github.com/brpl20/procstudio_blog)
[Blog](https://blog.procstudio.com.br/)

## Staging and Production:
- [Staging](https://admin_hml.procstudio.com.br/)
- [Production](https://procstudio.com.br/)
...
4. Honorary: When creating a work, it's important to set up the honorary amount that customers will be charged. There are four types of fees: Work (fixed rate), Success (% of gains), Both (both ways), and Bonus (Free pro bonus) and we have special features for previdenciary area.
...
### User Permissions => role and status
...
## Domains
PROCSTUDIO.APP.BR - PROCSTUDIO.BLOG.BR - PROCSTUDIO.COM.BR - PROCSTUDIOAI.COM.BR - PROCSTUDIOIA.COM.BR
